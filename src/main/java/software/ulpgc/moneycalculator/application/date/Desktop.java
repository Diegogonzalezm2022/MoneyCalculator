...
public class Desktop extends JFrame {
    ...
    private JPanel panel() {
        ...
        panel.add(updateDate = updateDate());
        return panel;
    }
    ...
    private Component calculateButton() {
        ...
        button.addActionListener(e->commands.get("update date").execute());
        return button;
    }
    ...
    public RateDisplay rateDateDisplay() {
        return rate -> updateDate.setText("Last updated: " + rate.date().toString());
    }
